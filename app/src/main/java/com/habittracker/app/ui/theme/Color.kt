...
// Habit-specific colors (a curated palette users can pick from)
val HabitColors = listOf(
    Color(0xFF6750A4), // Purple
    Color(0xFF006D40), // Green
    Color(0xFFBA1A1A), // Red
    Color(0xFF006A6A), // Teal
    Color(0xFF984061), // Pink
    Color(0xFF625B71), // Gray
    Color(0xFF006496), // Blue
    Color(0xFF8E562E), // Orange
    Color(0xFF4A6741), // Olive
    Color(0xFF6E3B8B), // Deep Purple
)
